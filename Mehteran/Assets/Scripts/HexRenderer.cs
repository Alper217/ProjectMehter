...
public class HexRenderer : MonoBehaviour
{
    ...
    private Face CreateFace(float innerRad,float outerRad, float heightA, float heightB, int point, bool reserve = false)
    {
        ...
        List<Vector3> vertices = new List<Vector3>() { pointA, pointB, pointC };
